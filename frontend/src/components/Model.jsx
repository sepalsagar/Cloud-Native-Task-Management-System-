...
import addTaskRequest from "../hooks/useAddTask";
import { toast } from "react-toastify";
import deleteTaskRequest from "../hooks/useDeleteTask";
import useGetTask from "../hooks/useGetTask";
import Loading from "./Loading";
import { getMonthDate, simpleDate } from "../utils/generateDate";
import updateTaskRequest from "../hooks/useUpdateTask";
import CheckBoxUnselect from "../assets/checkbox_unselect.png";
import CheckBoxSelect from "../assets/checkbox_select.png";
import addToBoardRequest from "../hooks/useAddToBoard";
import { checkValidEmail } from "../utils/validate";
import updateCategoryRequest from "../hooks/useUpdateCategory";
...
export const AddPeople = () => {
	...
	const handleAddToBoard = (e) => {
		...
		addToBoardRequest(e, setLoad, dispatch, email);
	};
	return (
...
export const TaskDelete = () => {
	...
	const handleTaskDelete = (e) => {
		deleteTaskRequest(e, setLoad, dispatch, id);
	};
